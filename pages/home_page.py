...
class HomePage:
    ...
    @step('Validate the home page is loaded')
    ...
    @step('Accept all cookies if cookie dialog is displayed')
    ...
    @step('Click on the Company navbar')
    def click_company_navbar(self):
        self.companyNavbar.click()

    @step('Verify the Company navbar is displayed')
    def verify_company_navbar(self):
        expect(self.companyNavbar).to_be_visible()
    
    @step('Click on the Careers navbar')
    def click_careers_navbar(self):
        self.careersNavbar.click()

    @step('Verify the Careers navbar is displayed')
